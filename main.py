...
async def help_command(ctx: commands.Context):
    ...
    embed.add_field(name="▶️ `!play <link/tên>`", value="Phát nhạc từ YouTube, SoundCloud, Spotify.", inline=False)
    ...
    embed.add_field(name="📋 `!queue`", value="Xem danh sách các bài hát đang nằm trong hàng đợi.", inline=False)
